...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="application_form.jsp" class="w3-bar-item w3-button w3-padding"><i class="fa fa-arrow-right"></i>  Application Form</a>
    <a href="application_status.jsp" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-arrow-right"></i>  Application Status</a>
...
<div class="w3-main mt-5 pt-3" style="margin-left:310px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h4 class="text-center"><b> Application Status</b></h4>
  </header>
...
<form action="GetStatusServlet">
  
  <label for="applicationid" class="form-label">Application Id:</label>
    <input type="text" class="form-control" id="applicationid" name="applicationid" required><br>
    
    <div class="text-center">
	<input class="btn btn-secondary" type="submit" value="Enter"><br>
</div>
