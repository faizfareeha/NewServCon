...
<% String loginResult = (String) request.getAttribute("loginResult"); %>
    ...
    <% } else if ("User not found".equals(loginResult)) { %>
...
<!-- <div class="row align-items-center" style="height: 100vh;">-->
  ...
  <h2 style="color: rgb(56, 56, 56); text-align: center;">LOG IN</h2> <br>
  
<form novalidate action="UsrLog">


<div class="row">
    <div class="col-12">	
	<input class="form-control" type="text" placeholder="User ID or Email ID" name="uid" id="uid" required/>
...
<div class="col">
	...
	New User:<br>
	<a href="regpage.jsp" class="btn btn-primary btn-sm">Register </a>
	</div>
