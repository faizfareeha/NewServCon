...
<div class="container d-flex justify-content-center my-5 p-2">
<div class="alert alert-success" role="alert">
  <h1 class="text-center">Application Submission Successful!</h1>
  <p class="text-center">(Application Id: ${applicationId})</p>
    <h3 class="text-center">Please keep a note of your Application Id <span class="fw-bold">${applicationId}</span> in order to check your Application Status. Thank you!</h3>
